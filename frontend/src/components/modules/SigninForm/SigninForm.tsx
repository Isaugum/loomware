...
export default function SigninForm() {
    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 max-w-[300px] w-full">
            ...
            <button type="submit" className="w-full p-2 bg-blue-500 text-white rounded-md" onClick={handleSubmit(onSubmit)}>Sign in</button>
            <p className="text-sm text-gray-500">Don't have an account? <Link href="/sign-up" className="text-blue-500">Sign up</Link></p>
        </div>
    )
}
